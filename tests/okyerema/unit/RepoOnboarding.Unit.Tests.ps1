...
# Pester 5 tests for okyerema repo onboarding health scripts
...
Describe "Get-RepoReadiness" {
    BeforeAll {
        $scriptPath = Join-Path $healthPath "Get-RepoReadiness.ps1"
...
Describe "Initialize-RepoAutomation" {
    BeforeAll {
        $scriptPath = Join-Path $healthPath "Initialize-RepoAutomation.ps1"
